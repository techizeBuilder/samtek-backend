...
exports.generateServiceInvoicePDF = exports.convertNumberToWords = void 0;
/**
 ...
 */
const generateServiceInvoicePDF = (res, invoiceData) => __awaiter(void 0, void 0, void 0, function* () {
    const PDFDocument = (yield Promise.resolve().then(() => __importStar(require('pdfkit')))).default;
    const { company = {}, customer = {}, machineDetails = {}, invoiceNo = '', date = '', ref = '', notes = '', items = [] } = invoiceData;
    ...
    doc.font('Helvetica').fontSize(8).fillColor(BLACK)
        .text((0, exports.convertNumberToWords)(grandTotal), L + 5, y + 17, { width: W * 0.53 - 10 });
...
exports.generateServiceInvoicePDF = generateServiceInvoicePDF;
