...
exports.seedCustomersDirectly = seedCustomersDirectly;
const mongoose_1 = __importDefault(require("mongoose"));
const Customer_js_1 = __importDefault(require("../models/Customer.js"));
// Direct seeding function that can be called internally
function seedCustomersDirectly() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log('Starting direct customer seeding...');
            // Clear existing customers
            yield Customer_js_1.default.deleteMany({});
            console.log('Cleared existing customers');
            // Complete 15 dummy customers with valid GSTIN format (15 chars: 2digits+10alphanumeric+1letter+1digit+1letter+1digit)
            ...
            const insertedCustomers = yield Customer_js_1.default.insertMany(sampleCustomers);
