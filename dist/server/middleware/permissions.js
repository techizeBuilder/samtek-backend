...
exports.getUserPermissions = exports.checkUnitAccess = exports.getUserModules = exports.checkPermission = void 0;
...
const checkPermission = (module, feature, action) => {
    return (req, res, next) => {
        ...
        try {
            ...
            if (user.role === 'Superadmin' || user.role === 'Super Admin' || ((_a = user.permissions) === null || _a === void 0 ? void 0 : _a.role) === 'super_admin') {
                return next();
            }
...
const checkUnitAccess = (req, res, next) => {
    ...
    if (user.role === 'Superadmin' || user.role === 'Super Admin' || ((_a = user.permissions) === null || _a === void 0 ? void 0 : _a.canAccessAllUnits)) {
        return next();
    }
...
const getUserPermissions = (user) => {
    ...
    if (user.role === 'Sales' || user.role === 'Sales Employee' || user.role === 'Sales Head') {
        ...
        const hasMarketingModule = (_a = basePermissions.modules) === null || _a === void 0 ? void 0 : _a.some(m => m.name === 'marketing');
