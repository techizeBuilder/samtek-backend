...
exports.checkFeaturePermission = exports.checkModulePermission = exports.checkRole = void 0;
...
const checkModulePermission = (moduleName, permission = 'view') => {
    return (req, res, next) => {
        var _a;
        if (!req.user) {
            return res.status(401).json({
        ...
        const modulePermission = req.user.permissions.modules.find(module => module.name === moduleName);
        if (!modulePermission) {
            return res.status(403).json({
                success: false,
        ...
        if (permission !== 'dashboard') {
            const hasPermission = (_a = modulePermission.features) === null || _a === void 0 ? void 0 : _a.some(feature => feature[permission] === true);
            if (!hasPermission) {
                return res.status(403).json({
                    success: false,
...
const checkFeaturePermission = (moduleName, featureKey, permission = 'view') => {
    return (req, res, next) => {
        var _a;
        if (!req.user) {
            return res.status(401).json({
        ...
        const featurePermission = (_a = modulePermission.features) === null || _a === void 0 ? void 0 : _a.find(feature => feature.key === featureKey);
