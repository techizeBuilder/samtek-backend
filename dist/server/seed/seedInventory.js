...
exports.seedInventoryData = void 0;
...
const seedInventoryData = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Seed categories
        yield Inventory_js_1.Category.insertMany(categories);
        console.log('Categories seeded successfully');
        // Seed customer categories
        yield Inventory_js_1.CustomerCategory.insertMany(customerCategories);
        console.log('Customer categories seeded successfully');
        // Seed items
        yield Inventory_js_1.Item.insertMany(items);
...
exports.seedInventoryData = seedInventoryData;
