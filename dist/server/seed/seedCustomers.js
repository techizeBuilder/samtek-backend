...
exports.seedCustomersRoute = exports.seedCustomers = void 0;
...
const seedCustomers = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log('Starting customer seeding process...');
        // Reset the collection first
        yield (0, resetCustomerCollection_js_1.resetCustomerCollection)();
        ...
        for (const item of customerData) {
            try {
                const customer = new Customer_js_1.default(item);
                yield customer.save();
...
const seedCustomersRoute = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield (0, exports.seedCustomers)();
        res.json(result);
    }
    catch (error) {
        res.status(500).json({
...
exports.seedCustomersRoute = seedCustomersRoute;
