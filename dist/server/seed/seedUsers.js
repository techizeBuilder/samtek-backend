...
const createSeedUsers = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const users = [
            {
                ...
                password: yield bcryptjs_1.default.hash('admin123', 12),
                fullName: 'Admin User',
                role: 'Super User',
                isActive: true,
                permissions: {
            ...
            },
            {
                ...
                password: yield bcryptjs_1.default.hash('unit123', 12),
                fullName: 'Unit Head',
                role: 'Unit Head',
                isActive: true,
                permissions: {
            ...
            },
            {
                ...
                password: yield bcryptjs_1.default.hash('prod123', 12),
            ...
            },
            {
                ...
                password: yield bcryptjs_1.default.hash('pack123', 12),
            ...
            },
            {
                ...
                password: yield bcryptjs_1.default.hash('disp123', 12),
            ...
            },
            {
                ...
                password: yield bcryptjs_1.default.hash('sales123', 12),
            ...
            },
            {
                ...
                password: yield bcryptjs_1.default.hash('acc123', 12),
        ...
        yield User_js_1.default.insertMany(users);
...
exports.default = createSeedUsers;
