...
const getSalesSummary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (filterCompanyId) {
            dailyFilter.companyId = new mongoose_1.default.Types.ObjectId(filterCompanyId);
        }
        ...
        const masterFilter = {};
        if (filterCompanyId) {
            masterFilter.companyId = new mongoose_1.default.Types.ObjectId(filterCompanyId);
        }
        ...
        let dailyDetails = yield ProductDetailsDailySummary_js_1.default.find(dailyFilter)
        ...
        if (isRange) {
            ...
            processedSummaries = dailyDetails.map(detail => {
                ...
                const masterProduct = masterProducts.find(mp => { var _a, _b, _c, _d; return ((_b = (_a = mp.productId) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString()) === ((_d = (_c = detail.productId) === null || _c === void 0 ? void 0 : _c._id) === null || _d === void 0 ? void 0 : _d.toString()); });
                let qtyPerBatch = (masterProduct === null || masterProduct === void 0 ? void 0 : masterProduct.qtyPerBatch) || detail.qtyPerBatch || 0;
                return {
                    _id: detail._id,
                    dailyDetailsId: detail._id,
                    productId: detail.productId,
                    productName: ((_a = detail.productId) === null || _a === void 0 ? void 0 : _a.name) || (masterProduct === null || masterProduct === void 0 ? void 0 : masterProduct.productName) || "Unknown",
            ...
            dailyDetails.forEach(detail => {
                var _a, _b, _c;
                const pId = ((_b = (_a = detail.productId) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString()) || ((_c = detail.productId) === null || _c === void 0 ? void 0 : _c.toString());
                if (pId)
                    dailyDetailsMap.set(pId, detail);
            });
            processedSummaries = masterProducts.map(masterProduct => {
                ...
                if ((_a = masterProduct.productId) === null || _a === void 0 ? void 0 : _a.batch) {
                ...
                return {
                    ...
                    date: summaryDate,
                    qtyPerBatch: qtyPerBatch,
                    packing: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.packing) || 0,
                    physicalStock: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.physicalStock) || 0,
                    batchAdjusted: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.batchAdjusted) || 0,
                    totalQuantity: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.totalQuantity) || 0,
                    totalIndent: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.totalIndent) || 0,
                    productionFinalBatches: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.productionFinalBatches) || 0,
                    toBeProducedDay: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.toBeProducedDay) || 0,
                    toBeProducedBatches: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.toBeProducedBatches) || 0,
                    produceBatches: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.produceBatches) || 0,
                    expiryShortage: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.expiryShortage) || 0,
                    balanceFinalBatches: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.balanceFinalBatches) || 0,
                    status: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.status) || 'pending',
                    hasDailyData: !!dailyDetail,
                    dailyDetailsId: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail._id) || null,
                    createdAt: masterProduct.createdAt,
                    updatedAt: (dailyDetail === null || dailyDetail === void 0 ? void 0 : dailyDetail.updatedAt) || masterProduct.updatedAt
                };
            });
        }
        // Step 5: Get sales breakdown for orders
        const salesBreakdown = yield (0, productionSummaryService_js_1.getSalesBreakdown)(masterProducts.map(s => s.productId), dailyFilter.date, filterCompanyId);
        ...
        const productsWithSalesData = processedSummaries.map(product => {
            ...
            const salesData = salesBreakdown.find(s => {
                ...
                return s.productId && product.productId &&
                    s.productId.toString() === (((_a = product.productId._id) === null || _a === void 0 ? void 0 : _a.toString()) || product.productId.toString());
            });
            return Object.assign(Object.assign({}, product), { 
                ...
                totalQuantity: Number(product.totalQuantity) || Number((_a = salesData === null || salesData === void 0 ? void 0 : salesData.summary) === null || _a === void 0 ? void 0 : _a.totalIndent) || 0, totalIndent: Number(product.totalIndent) || Number((_b = salesData === null || salesData === void 0 ? void 0 : salesData.summary) === null || _b === void 0 ? void 0 : _b.totalIndent) || 0, salesBreakdown: (salesData === null || salesData === void 0 ? void 0 : salesData.salesBreakdown) || [] });
        });
        // Step 7: Build the response with production groups
        const productGroups = yield ProductionGroup_js_1.default.find(Object.assign(Object.assign({}, (filterCompanyId && { company: filterCompanyId })), { isActive: true })).populate('items');
        const validProducts = productsWithSalesData.filter(p => p.productId && (p.productId._id || p.productId) && p.productName);
        const productionGroupsData = productGroups.map(group => {
            const groupProducts = validProducts.filter(product => {
                var _a;
                const pidStr = ((_a = product.productId._id) === null || _a === void 0 ? void 0 : _a.toString()) || product.productId.toString();
...
const updateSalesSummary = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Validate productId
        if (!mongoose_1.default.Types.ObjectId.isValid(actualProductId)) {
            return res.status(400).json({
                success: false,
        ...
        const masterProduct = yield ProductDailySummary_js_1.default.findOne({
            productId: new mongoose_1.default.Types.ObjectId(actualProductId)
        ...
        let dailyDetails = yield ProductDetailsDailySummary_js_1.default.findOne({
            date: summaryDate,
            productId: new mongoose_1.default.Types.ObjectId(actualProductId),
        ...
        if (!dailyDetails) {
            ...
            dailyDetails = new ProductDetailsDailySummary_js_1.default({
                date: summaryDate,
                productId: new mongoose_1.default.Types.ObjectId(actualProductId),
                productDailySummaryId: masterProduct._id,
                companyId: userCompanyId, // FIX: always use user's companyId for creation
                orderIds: orderIds ? orderIds.map(id => new mongoose_1.default.Types.ObjectId(id)) : []
            });
            ...
            if (orderIds && Array.isArray(orderIds)) {
                dailyDetails.orderIds = orderIds.map(id => new mongoose_1.default.Types.ObjectId(id));
        ...
        console.log('📌 Previous batchAdjusted:', oldBatchAdjusted, '→ New batchAdjusted:', (_a = updates.batchAdjusted) !== null && _a !== void 0 ? _a : oldBatchAdjusted);
        ...
        if (userRole === 'Unit Manager') {
            ...
            if (updates.status === 'approved' && oldStatus !== 'approved') {
                ...
                if (dailyDetails.batchAdjusted > 0) {
                    ...
                    const productionGroup = yield ProductionGroup_js_1.default.findOne({
                        ...
                        items: new mongoose_1.default.Types.ObjectId(actualProductId),
                        isActive: true
                    });
                    if (productionGroup) {
                        console.log(`   Product belongs to group: ${productionGroup.groupName}`);
                        // Get existing batches for this group (exclude completed ones)
                        const existingBatchDocs = yield ProductionBatch_js_1.default.find({
                        ...
                        const groupDailyDetails = yield ProductDetailsDailySummary_js_1.default.find({
                            date: today,
                        ...
                        if (batchesToCreate > 0) {
                            ...
                            for (const detail of groupDailyDetails) {
                                ...
                                if (!detail.qtyPerBatch || detail.qtyPerBatch === 0) {
                                    const item = yield Inventory_js_1.Item.findById(detail.productId).select('batch qty name').lean();
                                    console.log(`      Item data:`, { name: item === null || item === void 0 ? void 0 : item.name, batch: item === null || item === void 0 ? void 0 : item.batch, qty: item === null || item === void 0 ? void 0 : item.qty });
                                    if (item === null || item === void 0 ? void 0 : item.batch) {
                                        ...
                                        if (qtyFromBatch > 0) {
                                            ...
                                            yield ProductDetailsDailySummary_js_1.default.updateOne({ _id: detail._id }, { $set: { qtyPerBatch: qtyFromBatch } });
                            ...
                            for (let i = 0; i < batchesToCreate; i++) {
                                ...
                                let qtyPerBatch = ((_b = groupDailyDetails[0]) === null || _b === void 0 ? void 0 : _b.qtyPerBatch) || 0;
                                ...
                                if (qtyPerBatch === 0) {
                                    ...
                                    const item = yield Inventory_js_1.Item.findById(groupDailyDetails[0].productId).select('batch name').lean();
                                    console.log(`   📦 Item found:`, item === null || item === void 0 ? void 0 : item.name, `batch field =`, item === null || item === void 0 ? void 0 : item.batch, `type =`, typeof (item === null || item === void 0 ? void 0 : item.batch));
                                    if (item === null || item === void 0 ? void 0 : item.batch) {
                                ...
                                const existingBatch = yield ProductionBatch_js_1.default.findOne({
                                    companyId: masterProduct.companyId._id,
                                    batchNo: batchNo,
                                    productionDate: today
                                });
                            ...
                            if (fullBatches.length > 0) {
                                ...
                                const qtyPerBatch = ((_c = groupDailyDetails[0]) === null || _c === void 0 ? void 0 : _c.qtyPerBatch) || 0;
                        ...
                        yield createProductionBatchEntries({
            ...
            // so that ProductionBatch entries are removed.
                ...
                if (productionGroup) {
                    ...
                    let existingBatchDocs = yield ProductionBatch_js_1.default.find({
                        groupId: productionGroup._id,
                        companyId: masterProduct.companyId._id,
                        productionDate: today,
                        status: { $ne: 'completed' }
                    ...
                    if (remainder > 0) {
                        ...
                        for (const detail of groupDailyDetails) {
                            if (!detail.qtyPerBatch || detail.qtyPerBatch === 0) {
                                const item = yield Inventory_js_1.Item.findById(detail.productId).select('batch').lean();
                                if (item === null || item === void 0 ? void 0 : item.batch) {
                                    const qtyFromBatch = parseFloat(item.batch) || 0;
                                    if (qtyFromBatch > 0) {
                                        detail.qtyPerBatch = qtyFromBatch;
                        ...
                        const qtyPerBatch = ((_d = groupDailyDetails[0]) === null || _d === void 0 ? void 0 : _d.qtyPerBatch) || 0;
                    ...
                    if (requiredBatches < existingBatches) {
                        ...
                        const batchesToRemove = yield ProductionBatch_js_1.default.find({
                            "combinedItems.itemId": actualProductId,
                            companyId: masterProduct.companyId._id,
                            productionDate: today,
                            status: { $ne: 'completed' }
            ...
            // CASE 3: Status changed to pending
                ...
                const deletedByItemInArray = yield ProductionBatch_js_1.default.deleteMany({
                    "combinedItems.itemId": actualProductId,
                    companyId: masterProduct.companyId._id,
                    productionDate: today
                });
                ...
                const deletedByDirectId = yield ProductionBatch_js_1.default.deleteMany({
                ...
                const dailyDetailsForDate = yield ProductDetailsDailySummary_js_1.default.findOne({
                    productId: actualProductId,
                    date: today,
                    companyId: masterProduct.companyId._id
                });
                if (dailyDetailsForDate) {
                    const deletedByDailyId = yield ProductionBatch_js_1.default.deleteMany({
                ...
                const allBatchesWithProduct = yield ProductionBatch_js_1.default.find({
                    "combinedItems.itemId": actualProductId,
                    companyId: masterProduct.companyId._id,
                    productionDate: today
                });
                if (allBatchesWithProduct.length > 0) {
                    ...
                    for (const batch of allBatchesWithProduct) {
                        ...
                        yield ProductionBatch_js_1.default.deleteOne({ _id: batch._id });
                    }
                }
                ...
                if (productionGroup) {
                    ...
                    const groupDailyDetails = yield ProductDetailsDailySummary_js_1.default.find({
                        date: today,
                        productId: { $in: groupProductIds, $ne: new mongoose_1.default.Types.ObjectId(actualProductId) },
                        companyId: masterProduct.companyId._id,
                        status: 'approved'
                    });
                    ...
                    if (groupTotal > 0) {
                        ...
                        if (remainder > 0) {
                            ...
                            const qtyPerBatch = ((_e = groupDailyDetails[0]) === null || _e === void 0 ? void 0 : _e.qtyPerBatch) || 0;
                            const qtyAchieved = parseFloat((qtyPerBatch * remainder).toFixed(2));
                            // 🔒 Check if batch already exists to avoid duplicate key error
                            const existingBatch = yield ProductionBatch_js_1.default.findOne({
                                companyId: masterProduct.companyId._id,
                    ...
                    const deletedBatches = yield ProductionBatch_js_1.default.deleteMany({
                        "combinedItems.itemId": actualProductId,
                        companyId: masterProduct.companyId._id,
                        productionDate: today,
                        status: { $ne: 'completed' }
                    ...
                    const deletedStandalone = yield ProductionBatch_js_1.default.deleteMany({
                        itemId: actualProductId,
                        companyId: masterProduct.companyId._id,
                        productionDate: today,
                        status: { $ne: 'completed' }
            ...
            // This handles edge case where product is not in any group
                ...
                const deletedByItem = yield ProductionBatch_js_1.default.deleteMany({
                    "combinedItems.itemId": actualProductId,
                    companyId: masterProduct.companyId._id,
                    productionDate: today,
                    status: { $ne: 'completed' }
                ...
                if (productionGroup) {
                    ...
                    if (groupTotal > 0) {
                        ...
                        if (remainder > 0) {
                            ...
                            const qtyPerBatch = ((_f = groupDailyDetails[0]) === null || _f === void 0 ? void 0 : _f.qtyPerBatch) || 0;
                            const qtyAchieved = parseFloat((qtyPerBatch * remainder).toFixed(2));
                            const existingBatch = yield ProductionBatch_js_1.default.findOne({
                                companyId: masterProduct.companyId._id,
                                batchNo: batchNo,
        ...
        // entries so it no longer appears on the production sheet.
            ...
            const today = new Date(summaryDate);
            today.setUTCHours(0, 0, 0, 0);
            const deletedByCombinedItem = yield ProductionBatch_js_1.default.deleteMany({
                "combinedItems.itemId": actualProductId,
                companyId: masterProduct.companyId._id,
                productionDate: today,
                status: { $ne: 'completed' }
            });
            const deletedByDirectItem = yield ProductionBatch_js_1.default.deleteMany({
                itemId: actualProductId,
                companyId: masterProduct.companyId._id,
                productionDate: today,
                status: { $ne: 'completed' }
 ...
 */
const createProductionBatchEntries = (_a) => __awaiter(void 0, [_a], void 0, function* ({ productId, companyId, date, qtyPerBatch, produceBatches, batchAdjusted = 1, approvedBy, dailyDetailsId }) {
    try {
        ...
        if (!groupId) {
            ...
            for (let i = 0; i < fullBatches; i++) {
                ...
                const batchNo = `BATNO${String(currentBatchNumber).padStart(2, '0')}`;
                const batchEntry = yield ProductionBatch_js_1.default.create({
                    companyId,
                    groupId: null,
                    batchNumber: currentBatchNumber,
                    batchNo,
        ...
        const existingPartialBatches = yield ProductionBatch_js_1.default.find({
            companyId,
            groupId,
            productionDate: today,
            status: 'pending',
        ...
        for (const existingBatch of existingPartialBatches) {
            ...
            if (batchAdjusted <= availableSpace) {
                ...
                existingBatch.totalBatchAdjusted = parseFloat((existingBatch.totalBatchAdjusted + batchAdjusted).toFixed(2));
        ...
        const batchNo = `BATNO${String(nextBatchNumber).padStart(2, '0')}`;
        const newBatch = yield ProductionBatch_js_1.default.create({
            companyId,
            groupId,
            batchNumber: nextBatchNumber,
            batchNo,
