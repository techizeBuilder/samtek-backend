...
exports.uploadCompanyLogo = exports.updateThemeSettings = exports.updateBackupSettings = exports.updateNotificationSettings = exports.updateSystemSettings = exports.updateCompanySettings = exports.updateSettings = exports.getSettings = exports.upload = void 0;
...
const getSettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (req.user.role !== schema_js_1.USER_ROLES.SUPER_ADMIN) {
...
const updateSettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let settings = yield Settings_js_1.default.getSettings();
        // Update the settings
...
const updateCompanySettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (contact) {
            ...
            settings.company.contact = Object.assign(Object.assign({}, settings.company.contact), contact);
...
const updateSystemSettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (timeFormat)
            settings.system.timeFormat = timeFormat;
        if (language)
...
const updateNotificationSettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (roleNotifications) {
            ...
            if (!settings.notifications.roleSettings)
                settings.notifications.roleSettings = {};
            Object.keys(roleNotifications).forEach(role => {
                settings.notifications.roleSettings[role] = Object.assign(Object.assign({}, settings.notifications.roleSettings[role]), roleNotifications[role]);
            });
...
const updateBackupSettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (req.user.role !== schema_js_1.USER_ROLES.SUPER_ADMIN) {
            return res.status(403).json({ message: 'Access denied' });
        }
...
const updateThemeSettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (req.user.role !== schema_js_1.USER_ROLES.SUPER_ADMIN) {
            return res.status(403).json({ message: 'Access denied' });
        }
        ...
        const settings = yield Settings_js_1.default.getSettings();
        if (defaultTheme)
            settings.theme.defaultTheme = defaultTheme;
        if (typeof allowUserThemeChange === 'boolean')
            settings.theme.allowUserThemeChange = allowUserThemeChange;
        yield settings.save();
        res.json({
...
const uploadCompanyLogo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (settings.company.logo) {
            const oldLogoPath = path_1.default.join(process.cwd(), settings.company.logo.substring(1)); // Remove leading slash
