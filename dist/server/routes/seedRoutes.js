...
// Note: No auth middleware for development seeding
...
// Seed customers endpoint (no auth required for development)
router.post('/seed-customers', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
