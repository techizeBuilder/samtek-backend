...
exports.getInventoryStats = exports.getLowStockItems = exports.exportCustomerCategoriesToExcel = exports.exportCategoriesToExcel = exports.importItemsFromExcel = exports.exportItemsToExcel = exports.deleteCustomerCategory = exports.updateCustomerCategory = exports.createCustomerCategory = exports.getCustomerCategories = exports.deleteCategory = exports.updateCategory = exports.createCategory = exports.getCategories = exports.reorderItems = exports.adjustStock = exports.bulkDeleteItems = exports.deleteItem = exports.updateItem = exports.createItem = exports.getItemById = exports.getItems = void 0;
...
const checkInventoryPermission = (user, action) => {
    ...
    return ((_b = (_a = user.permissions) === null || _a === void 0 ? void 0 : _a.Inventory) === null || _b === void 0 ? void 0 : _b[action]) === true;
};
// Helper function to update qtyPerBatch in product summary
const updateProductSummaryQtyPerBatch = (productId, productName, qtyPerBatch, date, companyId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let existingSummary = yield ProductDailySummary_js_1.default.findOne(query);
...
const generateItemCode = (type) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (codeExists && codeAttempts < 100) {
        ...
        const globalCount = yield Inventory_js_1.Item.countDocuments({
        ...
        const existingItem = yield Inventory_js_1.Item.findOne({ code: uniqueCode });
...
const getItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log('User:', (_a = req.user) === null || _a === void 0 ? void 0 : _a.username, 'Role:', (_b = req.user) === null || _b === void 0 ? void 0 : _b.role, 'CompanyId:', (_c = req.user) === null || _c === void 0 ? void 0 : _c.companyId);
    console.log('Query params:', req.query);
    try {
        if (!checkInventoryPermission(req.user, 'view')) {
            return res.status(403).json({ message: 'Access denied. Insufficient permissions.' });
        }
        const { page = 1, limit = 20, search, type, category, subCategory, store, location, lowStock, quantity, // Add quantity filter
        sortBy = 'name', sortOrder = 'asc' } = req.query;
        ...
        try {
            ...
            const query_builder = Inventory_js_1.Item.find(query).sort(sortOptions).skip(skip);
            // Only apply limit if not Unit Head (Unit Head gets all items)
            if (actualLimit > 0) {
                query_builder.limit(actualLimit);
            }
            items = yield query_builder;
            total = yield Inventory_js_1.Item.countDocuments(query);
        ...
        const stats = yield Inventory_js_1.Item.aggregate([
            { $match: query },
            {
                $group: {
                    _id: null,
        ...
        const typeStats = yield Inventory_js_1.Item.aggregate([
            { $match: query },
            {
                $group: {
                    _id: '$type',
...
const getItemById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (id === 'export') {
            return (0, exports.exportItemsToExcel)(req, res);
        }
        ...
        const item = yield Inventory_js_1.Item.findOne(query);
        if (!item) {
...
const createItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (itemData.name && itemData.name.trim()) {
            ...
            const existingItemByName = yield Inventory_js_1.Item.findOne(query);
        ...
        if (!itemData.code || itemData.code.trim() === '') {
            itemData.code = yield generateItemCode(itemData.type);
        }
        else {
            ...
            const existingItem = yield Inventory_js_1.Item.findOne(codeQuery);
            if (existingItem) {
        ...
        const item = yield Inventory_js_1.Item.create(sanitizedData);
        ...
        try {
            ...
            if (companyId) {
                yield (0, productionSummaryService_js_1.initializeProductSummary)(item._id.toString(), item.name, companyId);
                ...
                if (item.batch && !isNaN(parseFloat(item.batch))) {
                    ...
                    yield updateProductSummaryQtyPerBatch(item._id.toString(), item.name, parseFloat(item.batch), today, companyId);
        ...
        try {
            yield notificationService_js_1.default.triggerInventoryNotification(item, 'created');
            // Check for low stock alert
            if (item.qty <= (item.minStock || 10)) {
                yield notificationService_js_1.default.triggerLowStockNotification(item);
            }
        }
...
const sanitizeItemData = (data) => {
    ...
    if (sanitized.code)
        sanitized.code = sanitized.code.trim();
    if (sanitized.category)
        sanitized.category = sanitized.category.trim();
    if (sanitized.subCategory)
        sanitized.subCategory = sanitized.subCategory.trim();
    if (sanitized.customerCategory)
        sanitized.customerCategory = sanitized.customerCategory.trim();
    if (sanitized.type)
        sanitized.type = sanitized.type.trim();
    if (sanitized.importance)
        sanitized.importance = sanitized.importance.trim();
    if (sanitized.batch)
        sanitized.batch = sanitized.batch.trim();
    if (sanitized.quality)
        sanitized.quality = sanitized.quality.trim();
    if (sanitized.unit)
        sanitized.unit = sanitized.unit.trim();
    if (sanitized.store)
        sanitized.store = sanitized.store.trim();
    if (sanitized.hsn)
        sanitized.hsn = sanitized.hsn.trim();
    if (sanitized.description)
        sanitized.description = sanitized.description.trim();
    if (sanitized.internalNotes)
        sanitized.internalNotes = sanitized.internalNotes.trim();
    // Convert numeric fields
    if (sanitized.qty !== undefined)
        sanitized.qty = Number(sanitized.qty);
    if (sanitized.stdCost !== undefined)
        sanitized.stdCost = Number(sanitized.stdCost);
    if (sanitized.purchaseCost !== undefined)
        sanitized.purchaseCost = Number(sanitized.purchaseCost);
    if (sanitized.salePrice !== undefined)
        sanitized.salePrice = Number(sanitized.salePrice);
    if (sanitized.mrp !== undefined)
        sanitized.mrp = Number(sanitized.mrp);
    if (sanitized.gst !== undefined)
        sanitized.gst = Number(sanitized.gst);
    if (sanitized.minStock !== undefined)
        sanitized.minStock = Number(sanitized.minStock);
    if (sanitized.leadTime !== undefined)
        sanitized.leadTime = Number(sanitized.leadTime);
    if (sanitized.order !== undefined)
        sanitized.order = Number(sanitized.order);
...
const updateItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (itemData.code && itemData.code.trim() !== '') {
            const existingItem = yield Inventory_js_1.Item.findOne({
                code: itemData.code.trim(),
                _id: { $ne: id }
            });
            if (existingItem) {
        ...
        // Sanitize and prepare data
        const sanitizedData = sanitizeItemData(itemData);
        const item = yield Inventory_js_1.Item.findByIdAndUpdate(id, sanitizedData, { new: true, runValidators: true });
        if (!item) {
            return res.status(404).json({ message: 'Item not found' });
        }
...
const deleteItem = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { id } = req.params;
        const item = yield Inventory_js_1.Item.findById(id);
        if (!item) {
            return res.status(404).json({ message: 'Item not found' });
        }
        // Delete the item
        yield Inventory_js_1.Item.findByIdAndDelete(id);
        // Clean up production summary entries for this item
        try {
            const deleteResult = yield ProductDailySummary_js_1.default.deleteMany({
                productId: id
            });
...
const bulkDeleteItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!checkInventoryPermission(req.user, 'delete')) {
            return res.status(403).json({ message: 'Access denied. Insufficient permissions.' });
        }
        ...
        const existingItems = yield Inventory_js_1.Item.find({ _id: { $in: itemIds } });
        ...
        const deleteResult = yield Inventory_js_1.Item.deleteMany({ _id: { $in: existingIds } });
        // Clean up production summary entries for deleted items
        try {
            const summaryDeleteResult = yield ProductDailySummary_js_1.default.deleteMany({
...
const reorderItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!checkInventoryPermission(req.user, 'edit')) {
            return res.status(403).json({ message: 'Access denied. Insufficient permissions.' });
        }
        ...
        if (bulkOps.length > 0) {
            yield Inventory_js_1.Item.bulkWrite(bulkOps);
        }
...
const getCategories = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        console.log('🔍 GetCategories called by:', (_a = req.user) === null || _a === void 0 ? void 0 : _a.role);
        if (!checkInventoryPermission(req.user, 'view')) {
            return res.status(403).json({ message: 'Access denied. Insufficient permissions.' });
        }
        let categories;
        ...
        if (req.user.role === 'Unit Head' && req.user.companyId) {
            ...
            const allCategories = yield Inventory_js_1.Category.find().sort({ createdAt: -1, name: 1 });
            // Add product count for each category (company-specific)
            categories = yield Promise.all(allCategories.map((category) => __awaiter(void 0, void 0, void 0, function* () {
                const productCount = yield Inventory_js_1.Item.countDocuments({
            ...
            categories = yield Inventory_js_1.Category.find().sort({ createdAt: -1, name: 1 });
...
const createCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const category = yield Inventory_js_1.Category.create(categoryData);
...
const updateCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const category = yield Inventory_js_1.Category.findByIdAndUpdate(id, updateData, { new: true, runValidators: true });
        if (!category) {
            return res.status(404).json({
                success: false,
...
const deleteCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const itemsUsingCategory = yield Inventory_js_1.Item.countDocuments({
            $or: [
                { category: id },
                { category: (_a = (yield Inventory_js_1.Category.findById(id))) === null || _a === void 0 ? void 0 : _a.name }
            ]
        });
        ...
        const category = yield Inventory_js_1.Category.findByIdAndDelete(id);
        if (!category) {
...
const getCustomerCategories = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const customerCategories = yield Inventory_js_1.CustomerCategory.find().sort({ createdAt: -1, name: 1 });
...
const createCustomerCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const customerCategory = yield Inventory_js_1.CustomerCategory.create({ name, description });
        res.status(201).json({
...
const updateCustomerCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const customerCategory = yield Inventory_js_1.CustomerCategory.findByIdAndUpdate(id, updateData, { new: true, runValidators: true });
        if (!customerCategory) {
...
const deleteCustomerCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { id } = req.params;
        const customerCategory = yield Inventory_js_1.CustomerCategory.findByIdAndDelete(id);
        if (!customerCategory) {
            return res.status(404).json({ message: 'Customer category not found' });
        }
...
const exportItemsToExcel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const items = yield Inventory_js_1.Item.find(query).sort({ createdAt: -1 });
...
exports.exportItemsToExcel = exportItemsToExcel;
// Import items from Excel
exports.importItemsFromExcel = [upload.single('file'), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        try {
            ...
            for (let i = 0; i < jsonData.length; i++) {
                ...
                try {
                    ...
                    const matchingType = validTypes.find(validType => validType.toLowerCase() === normalizedType.toLowerCase());
                    if (!matchingType) {
                    ...
                    if (itemData.store) {
                        ...
                        try {
                            ...
                            if (itemData.store.match(/^[0-9a-fA-F]{24}$/)) {
                                ...
                                try {
                                    company = yield Company.findById(itemData.store);
                            ...
                            if (req.user.role === 'Unit Head' && req.user.companyId) {
                                ...
                                if (userCompanyId !== itemCompanyId) {
                                    ...
                                    const userCompany = yield Company.findById(req.user.companyId).select('name');
                    ...
                    const existingItem = yield Inventory_js_1.Item.findOne(duplicateQuery);
                    ...
                    const matchingImportance = validImportance.find(validImp => validImp.toLowerCase() === normalizedImportance.toLowerCase());
                    ...
                    while (codeExists && codeAttempts < 100) {
                        ...
                        const existingItemByCode = yield Inventory_js_1.Item.findOne({ code: uniqueCode });
                    ...
                    if (itemData.category && itemData.category.trim()) {
                        ...
                        const categoryExists = yield Inventory_js_1.Category.findOne({
                        ...
                        if (!categoryExists) {
                            ...
                            const availableCategories = yield Inventory_js_1.Category.find({}).select('name').limit(10);
                            ...
                            if (itemData.subCategory && itemData.subCategory.trim()) {
                                ...
                                const subCategoryExists = categoryExists.subcategories.some(sub => sub.toLowerCase() === trimmedSubCategory.toLowerCase());
                                if (!subCategoryExists) {
                                    ...
                                    const exactSubCategory = categoryExists.subcategories.find(sub => sub.toLowerCase() === trimmedSubCategory.toLowerCase());
                    ...
                    if (itemData.customerCategory && itemData.customerCategory.trim()) {
                        ...
                        const customerCategoryExists = yield Inventory_js_1.CustomerCategory.findOne({
                        ...
                        if (!customerCategoryExists) {
                            ...
                            const availableCustomerCategories = yield Inventory_js_1.CustomerCategory.find({}).select('name').limit(10);
                    ...
                    if (itemData.store) {
                        try {
                            const { Company } = yield Promise.resolve().then(() => __importStar(require('../models/Company.js')));
                            const company = yield Company.findById(itemData.store);
                            if (company) {
                    ...
                    // Create new item
                    const newItem = yield Inventory_js_1.Item.create(itemData);
                    ...
                    if (companyIdForCheck) {
                        try {
                            ...
                            if (!existingSummary) {
                                ...
                                const newSummary = yield ProductDailySummary_js_1.default.create(summaryData);
                    ...
                    console.error(`❌ ERROR processing row ${rowNumber}:`, {
                        itemName: (itemData === null || itemData === void 0 ? void 0 : itemData.name) || 'Unknown',
                        storeLocation: (itemData === null || itemData === void 0 ? void 0 : itemData.store) || 'Unknown',
                        originalRowData: row,
                        errorMessage: rowError.message,
                        errorStack: (_a = rowError.stack) === null || _a === void 0 ? void 0 : _a.split('\n')[0]
                    });
            ...
            // Final verification
            const finalCount = yield Inventory_js_1.Item.countDocuments();
...
const exportCategoriesToExcel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const categories = yield Inventory_js_1.Category.find({}).sort({ createdAt: -1 });
...
const exportCustomerCategoriesToExcel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log('Starting Excel export for customer categories');
        const customerCategories = yield Inventory_js_1.CustomerCategory.find({}).sort({ createdAt: -1 });
...
exports.exportCustomerCategoriesToExcel = exportCustomerCategoriesToExcel;
// UTILITY CONTROLLERS
const getLowStockItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const lowStockItems = yield Inventory_js_1.Item.find(query).sort({ qty: 1 });
...
const getInventoryStats = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log('User:', (_a = req.user) === null || _a === void 0 ? void 0 : _a.username, 'Role:', (_b = req.user) === null || _b === void 0 ? void 0 : _b.role, 'CompanyId:', (_c = req.user) === null || _c === void 0 ? void 0 : _c.companyId);
    try {
        console.log('DEBUG: getInventoryStats called for user:', (_d = req.user) === null || _d === void 0 ? void 0 : _d.username, 'role:', (_e = req.user) === null || _e === void 0 ? void 0 : _e.role);
        if (!checkInventoryPermission(req.user, 'view')) {
            console.log('DEBUG: Permission check failed for user:', (_f = req.user) === null || _f === void 0 ? void 0 : _f.username);
            return res.status(403).json({ message: 'Access denied. Insufficient permissions.' });
        }
        console.log('DEBUG: Permission check passed for user:', (_g = req.user) === null || _g === void 0 ? void 0 : _g.username);
        ...
        const stats = yield Inventory_js_1.Item.aggregate(pipeline);
        ...
        const categoryStats = yield Inventory_js_1.Item.aggregate(categoryPipeline);
        ...
        const typeStats = yield Inventory_js_1.Item.aggregate(typePipeline);
        res.json({
            stats: Object.assign(Object.assign({}, stats[0] || { totalItems: 0, totalValue: 0, totalQty: 0, lowStockCount: 0 }), { totalCategories: categoryStats.length }),
            categoryStats,
            typeStats
        });
    }
