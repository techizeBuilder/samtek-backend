...
const PackagingJobSchema = new mongoose_1.default.Schema({
...
PackagingJobSchema.index({ company: 1, productionOrderId: 1 }, { unique: true, partialFilterExpression: { productionOrderId: { $exists: true, $type: 'objectId' } } });
exports.default = mongoose_1.default.model('PackagingJob', PackagingJobSchema);
