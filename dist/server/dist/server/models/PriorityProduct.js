...
const priorityProductSchema = new mongoose_1.default.Schema({
    userId: {
...
const PriorityProduct = mongoose_1.default.model('PriorityProduct', priorityProductSchema);
exports.default = PriorityProduct;
