...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const qcUser = yield User_js_1.default.findOne({ email: 'qchead@gmail.com' }).lean();
        if (!qcUser) {
        ...
        const deleted = yield QCJob_js_1.default.deleteMany({ company });
        ...
        const jobs = [
            // 1. Pending - Raw Material from Purchase
            {
                ...
                status: 'Pending',
                checklist: checklist['Raw Material'].map(c => (Object.assign(Object.assign({}, c), { status: 'Pending', actualValue: '', remarks: '' }))),
            ...
            // 2. Pending - Machine from Production
            {
                ...
                status: 'Pending',
                checklist: checklist['Machine'].map(c => (Object.assign(Object.assign({}, c), { status: 'Pending', actualValue: '', remarks: '' }))),
            ...
            // 6. Approved - Finished Good
            {
                ...
                transferredToStore: true,
                checklist: checklist['Finished Good'].map(c => (Object.assign(Object.assign({}, c), { actualValue: 'As per spec', status: 'Pass', remarks: '' }))),
                notes: '',
                company, createdBy: userId,
            },
        ...
        const inserted = yield QCJob_js_1.default.insertMany(jobs);
