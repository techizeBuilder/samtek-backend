...
Object.defineProperty(exports, "__esModule", { value: true });
exports.seedBrandsAndProducts = void 0;
...
const seedBrandsAndProducts = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log('🌱 Starting Brand and Product seeding...');
        // Connect to MongoDB if not connected
        if (mongoose_1.default.connection.readyState !== 1) {
            yield mongoose_1.default.connect('mongodb+srv://jeeturadicalloop:Mjvesqnj8gY3t0zP@cluster0.by2xy6x.mongodb.net/manuerp');
        }
        // Clear existing data
        yield Brand_js_1.default.deleteMany({});
        yield Product_js_1.default.deleteMany({});
        console.log('🗑️ Cleared existing brands and products');
        // Insert brands
        const insertedBrands = yield Brand_js_1.default.insertMany(brands);
        ...
        insertedBrands.forEach((brand, brandIndex) => {
            ...
            for (let i = startIndex; i < endIndex; i++) {
                if (productTemplates[i]) {
                    products.push(Object.assign(Object.assign({}, productTemplates[i]), { brandId: brand._id }));
                }
            }
        });
        // Insert products
        const insertedProducts = yield Product_js_1.default.insertMany(products);
        console.log(`✅ Inserted ${insertedProducts.length} products`);
        // Display summary
        console.log('\n📊 SEEDING SUMMARY:');
        console.log('==================');
        for (const brand of insertedBrands) {
            const productCount = yield Product_js_1.default.countDocuments({ brandId: brand._id });
...
exports.seedBrandsAndProducts = seedBrandsAndProducts;
// Run seeding if this file is executed directly
if (import.meta.url === `file://${process.argv[1]}`) {
    (0, exports.seedBrandsAndProducts)()
        .then(() => {
