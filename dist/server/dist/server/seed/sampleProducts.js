...
function seedProducts() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const insertedProducts = yield Inventory_js_1.Item.insertMany(sampleProducts);
...
if (process.argv[1] === new URL(import.meta.url).pathname) {
    mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/samtek')
        .then(() => {
